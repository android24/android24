...
- 🌍 Organizer at **Chengdu Google Developer Group (GDG)**
...
| Project | Focus | Live GitHub data |
| --- | --- | --- |
| [Hello Android](https://github.com/android24/hello-android) | A full-stack Android development course. | ![Hello Android last commit](https://img.shields.io/github/last-commit/android24/hello-android?label=Updated&style=flat) ![Hello Android stars](https://img.shields.io/github/stars/android24/hello-android?label=Stars&style=flat) |
| [Android Cross-Platform Lab](https://github.com/android24/Android-Cross-Platform-Lab) | Hybrid, React Native, Flutter, and Kotlin Multiplatform in one learning path. | ![Android Cross-Platform Lab last commit](https://img.shields.io/github/last-commit/android24/Android-Cross-Platform-Lab?label=Updated&style=flat) ![Android Cross-Platform Lab stars](https://img.shields.io/github/stars/android24/Android-Cross-Platform-Lab?label=Stars&style=flat) |
| [DroidStack](https://github.com/android24/DroidStack) | Principles and practical use of Android open-source frameworks. | ![DroidStack last commit](https://img.shields.io/github/last-commit/android24/DroidStack?label=Updated&style=flat) ![DroidStack stars](https://img.shields.io/github/stars/android24/DroidStack?label=Stars&style=flat) |
| [ResponsiveGPT](https://github.com/android24/ResponsiveGPT) | An ongoing exploration of AI applications. | ![ResponsiveGPT last commit](https://img.shields.io/github/last-commit/android24/ResponsiveGPT?label=Updated&style=flat) ![ResponsiveGPT stars](https://img.shields.io/github/stars/android24/ResponsiveGPT?label=Stars&style=flat) |
...
My latest public work and full contribution history are available on my [GitHub profile](https://github.com/android24). The project badges above are updated directly from their public GitHub repositories.

## Let's connect

<p>
  <a href="https://www.linkedin.com/in/fujun-gong/"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/linkedin/linkedin-original.svg" alt="LinkedIn" width="32" height="32" /></a>
  &nbsp;
  <a href="mailto:jackgong758@gmail.com"><img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/google/google-original.svg" alt="Email" width="32" height="32" /></a>
</p>
